...
Make sure you read through the "what's new in 3.0" document https://docs.bigbluebutton.org/3.0/new and specifically https://docs.bigbluebutton.org/3.0/new#other-notable-changes
